...
public class TouchController {
    ...
    public static float TOUCHDOWNX, TOUCHDOWNY, TOUCHUPX, TOUCHUPY;
    ...
    public void touchMovement(MotionEvent event){
       ...
       // if(System.currentTimeMillis() - prevupdateTime > 500) {
    ...
    public float getTouchUpX(){return TOUCHUPX;}
    public float getTouchUpY(){return TOUCHUPY;}
